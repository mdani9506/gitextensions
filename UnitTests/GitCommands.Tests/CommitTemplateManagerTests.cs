...
namespace GitCommandsTests
{
    ...
    public class CommitTemplateManagerTests
    {
        ...
        public void Register_should_not_add_duplicates()
        {
            ...
            _manager.Register(templateName, () => "text1", null, false);
            _manager.Register(templateName, () => "text2", null, false);
        ...
        {
            _manager.Register("template1", () => "text1", null, false);
            _manager.Register("template2", () => "text2", null, false);
            ...
            foreach (var managerRegisteredTemplate in _manager.RegisteredTemplates)
            {
                ...
                _manager.Register($"template{i}", () => "text", null, false);
                i++;
            }
        }
